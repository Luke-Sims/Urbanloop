...
def detect_rails(
    ...
    if debug:
        ...
        cv2.line(
            overlay, (int(vp_min), y_top), (int(vp_min), y_top + 30), (255, 255, 255), 2
        )
        cv2.line(
            overlay, (int(vp_max), y_top), (int(vp_max), y_top + 30), (255, 255, 255), 2
        )
    ...
    if left_poly is not None:
        draw_polynomial_line(
            overlay, left_poly, y_bottom, y_top, color=(0, 255, 0), thickness=4
        )

    if right_poly is not None:
        draw_polynomial_line(
            overlay, right_poly, y_bottom, y_top, color=(0, 255, 0), thickness=4
        )
...
def main():
    ...
    # Configuration
    source = "videoRgb.avi"  # Remplacer par votre vidéo
    ...
    while True:
        ...
        overlay, edges, left_poly, right_poly = detect_rails(
            ...
            prev_right_poly=prev_right_poly,
            debug=True,
